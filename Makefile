...
am_projet_c_OBJECTS = main.$(OBJEXT) support.$(OBJEXT) \
	interface.$(OBJEXT) callbacks.$(OBJEXT)
projet_c_OBJECTS = $(am_projet_c_OBJECTS)
am__DEPENDENCIES_1 =
projet_c_DEPENDENCIES = $(am__DEPENDENCIES_1)
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 = 
SOURCES = $(projet_c_SOURCES)
DIST_SOURCES = $(projet_c_SOURCES)
...
ACLOCAL = ${SHELL} "/home/user/Desktop/projetc (1)/projet c/missing" aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} "/home/user/Desktop/projetc (1)/projet c/missing" autoconf
AUTOHEADER = ${SHELL} "/home/user/Desktop/projetc (1)/projet c/missing" autoheader
AUTOMAKE = ${SHELL} "/home/user/Desktop/projetc (1)/projet c/missing" automake-1.15
AWK = mawk
CATALOGS = 
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = 
MAKEINFO = ${SHELL} "/home/user/Desktop/projetc (1)/projet c/missing" makeinfo
MKDIR_P = /bin/mkdir -p
...
abs_builddir = /home/user/Desktop/projetc (1)/projet c/src
abs_srcdir = /home/user/Desktop/projetc (1)/projet c/src
abs_top_builddir = /home/user/Desktop/projetc (1)/projet c
abs_top_srcdir = /home/user/Desktop/projetc (1)/projet c
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} '/home/user/Desktop/projetc (1)/projet c/install-sh'
...
projet_c_LDADD = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lglib-2.0 -lfontconfig -lfreetype $(INTLLIBS)
all: all-am
...
projet-c$(EXEEXT): $(projet_c_OBJECTS) $(projet_c_DEPENDENCIES) $(EXTRA_projet_c_DEPENDENCIES) 
	@rm -f projet-c$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(projet_c_OBJECTS) $(projet_c_LDADD) $(LIBS)
